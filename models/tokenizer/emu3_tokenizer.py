...
data_config = {
    ...
    'Calvin_static': {
        ...
        'VIDEO_CODES_SAVE': '/share/user/iperror/data/univla/processed_data/calvin_abcd_codes',
    ...
    'Calvin_gripper': {
        ...
        'SIZE': (80, 80),
        'VIDEO_ROOT': '/share/user/iperror/data/univla/processed_data/calvin_abcd',
        'VIDEO_CODES_SAVE': '/share/user/iperror/data/univla/processed_data/calvin_abcd_gripper_codes',
        'VIDEO_RECON_SAVE': '/share/user/iperror/data/univla/processed_data/calvin_abcd_gripper_recon'
    },
    'Calvin_partial': {
        'min_pixels': 80 * 80,
        'interval': 1,
    ...
    'libero': {
        ...
        'VIDEO_CODES_SAVE': '/share/user/iperror/data/univla/processed_data/libero_all_codes_200',
    ...
    'bridge_orig': {
        ...
        'interval': 1,
        'SIZE': (256, 256),
        'VIDEO_ROOT': '/share/user/iperror/data/univla/processed_data/bridge',
        'VIDEO_CODES_SAVE': '/share/user/iperror/data/univla/processed_data/bridge_orig_codes_256',
        'VIDEO_RECON_SAVE': '/share/user/iperror/data/univla/processed_data/bridge_orig_recon'
    },
    'maniskill': {
        'min_pixels': 128 * 128,
        'interval': 1,
    ...
    'ur5e_onetask_stastic': {
        'min_pixels': 80 * 80,
        'interval': 1,
        'SIZE': (256, 256),
        'VIDEO_ROOT': '/data/user/wsong890/user68/project/UniVLA/real_data/debug_real_data',
        'VIDEO_CODES_SAVE': '/data/user/wsong890/user68/project/UniVLA/real_data/debug_real_data_codes_256',
        'VIDEO_RECON_SAVE': '/data/user/wsong890/user68/project/UniVLA/debug_recon/debug_real_data_recon_256'
    },
    'ur5e_onetask_gripper': {
        'min_pixels': 80 * 80,
        'interval': 1,
        'SIZE': (80, 80),
        'VIDEO_ROOT': '/data/user/wsong890/user68/project/UniVLA/real_data/debug_real_data',
        'VIDEO_CODES_SAVE': '/data/user/wsong890/user68/project/UniVLA/real_data/debug_real_data_gripper_codes',
        'VIDEO_RECON_SAVE': '/data/user/wsong890/user68/project/UniVLA/debug_recon/debug_real_data_gripper_recon'
    },
} 
...
if __name__ == "__main__":
    ...
    MODEL_HUB = "/share/user/iperror/data/univla/UniVLA/Emu3-VisionTokenizer"
    path = "/share/user/iperror/data/univla/UniVLA/Emu3-VisionTokenizer"
    ...
    videos = sorted(os.listdir(VIDEO_ROOT))[rank::2]
    ...
    multi_view_datasets = ['taco_play','aloha','bridge_orig', 'berkeley_autolab_ur5', 'aloha_pour','aloha_songling',\
         'aloha_8task', 'aloha_fold','ur5e_onetask']
    ...
    for video in tqdm(videos, desc="Processing videos"):
        ...
        if process_data in single_view_datasets:
        ...
        elif process_data == 'Calvin_static':
            images, image_paths = load_images(osp.join(VIDEO_ROOT, video,'rgb_static'), SIZE, interval)
        elif process_data == 'Calvin_gripper':
            ...
            # print(f"Processing libero dataset: {video}")
            # remember to process the images and gripper images
            # images, image_paths = load_images(osp.join(VIDEO_ROOT, video, 'images'), SIZE, interval)
            images, image_paths = load_images(osp.join(VIDEO_ROOT, video,'images'), SIZE, interval)
        elif process_data == 'libero_gripper':
            # remember to process the images and gripper images
            # images, image_paths = load_images(osp.join(VIDEO_ROOT, video, 'images'), SIZE, interval)
            ...
            images, image_paths = load_images(osp.join(VIDEO_ROOT, video,'rgb_static'), SIZE, interval)
            # images, image_paths = load_images(osp.join(VIDEO_ROOT, video,'rgb_gripper'), SIZE, interval)
        elif process_data == 'ur5e_onetask_stastic':
            images, image_paths = load_images(osp.join(VIDEO_ROOT, video,'rgb_static'), SIZE, interval)
        elif process_data == 'ur5e_onetask_gripper':
            images, image_paths = load_images(osp.join(VIDEO_ROOT, video,'rgb_gripper'), SIZE, interval)
