...
# emu_hub=/data/user/wsong890/user68/project/UniVLA/logs/UNIVLA_CALVIN_ABCD_VIDEO_BS128_12k_NOPOSTTRAIN/checkpoint-9000
GPUS_PER_NODE=1

torchrun --nnodes=1 --nproc_per_node=$GPUS_PER_NODE --master_port=7878 eval/calvin/evaluate_ddp-emu.py \
--emu_hub $emu_hub \
--raw_calvin \
> ./log/eval_calvin_univla.log 2>&1 
# --debug \
