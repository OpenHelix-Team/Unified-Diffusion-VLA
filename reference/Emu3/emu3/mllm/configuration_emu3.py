...
class Emu3Config(PretrainedConfig):
    ...
    def __init__(
        ...
        qkv_bias: bool = False,
        use_blockwise_attn_mask: bool = False,
        use_bidirectional_attn_mask: bool = False,
        **kwargs,
    ):
        ...
        self.use_blockwise_attn_mask = use_blockwise_attn_mask
        self.use_bidirectional_attn_mask = use_bidirectional_attn_mask
        super().__init__(
