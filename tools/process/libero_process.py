...
dataset_dirs = f"/data/user/wsong890/user68/project/openvla-consitent/modified_libero_rlds/{sub_dataname}/1.0.0"
...
base_output_dir = "/share/user/iperror/data/univla/processed_data/libero_all"
