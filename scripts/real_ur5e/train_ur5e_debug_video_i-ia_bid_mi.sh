...
DATAPATH='/data/user/wsong890/user68/project/UniVLA/real_data/meta/debug_real_data_norm_256.pkl'
ACTION_TOKENIZER_PATH="/data/user/wsong890/user68/project/UniVLA/pretrain/fast_debug_real_data_t5_s50"
# EXP_NAME="UNIVLA_CALVIN_ABCD_VIDEO_BS192_8k"
EXP_NAME="UNIVLA_DEBUG_REAL_DATA_VIDEO_BS64_24k_I2IA_mi_256_0925"
...
torchrun \
    ...
    --attn_type "None" \
    --max_action_len 65 \
    > ./logs/real_ur5e/train_with_i_ia_mi_debug_real_data_256.log 2>&1
